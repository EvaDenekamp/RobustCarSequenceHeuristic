# This file is the adjusted result file of the packages alns (https://github.com/N-Wouda/ALNS).
# The adjustments: save plots; show combined operators for operator diagnostics instead of destroy and repair separated.
...
from alns.Statistics import Statistics  # pylint: disable=unused-import
...
class Result:
    ...
    def plot_objectives(self, ax=None, title=None, file_name=None, **kwargs):
        """
        ...
        plt.savefig('Objective_{}.png'.format(file_name))

    def plot_operator_counts(self, figure=None, title=None, file_name=None, legend=None,
                             **kwargs):
        """
        ...
        if figure is None:
            ...
            figure, (d_ax) = plt.subplots(nrows=1)
        ...
        plt.draw_if_interactive()
        plt.savefig('Operators_{}.png'.format(file_name))
